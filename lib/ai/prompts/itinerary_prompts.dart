...
- "Accommodation" and "Miscellaneous" should keep "items" as an empty array — this level of detail doesn't apply there (accommodation is already covered by "recommendedAccommodations", and Miscellaneous is inherently a catch-all).
