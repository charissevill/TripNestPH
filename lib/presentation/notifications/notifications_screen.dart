...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: uid == null
          ? const EmptyStateWidget(icon: Symbols.notifications_rounded, title: 'Sign in required', message: 'Sign in to view your notifications.')
          : StreamBuilder<List<AppNotification>>(
              ...
              builder: (context, snapshot) {
                ...
                final notifications = (snapshot.data ?? const [])
                    .where((n) => !_disabledCategories.contains(n.category.name))
                    .toList();
                if (notifications.isEmpty) {
                  return const EmptyStateWidget(
                    icon: Symbols.notifications_rounded,
                    title: 'You\'re all caught up',
                    message: 'Festival announcements and travel tips will show up here.',
                  );
                }
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: notification.isRead ? theme.colorScheme.surface : AppColors.primary.withValues(alpha: 0.06),
                          borderRadius: BorderRadius.circular(AppRadius.lg),
                          boxShadow: [
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Icon(_iconFor(notification.category), color: AppColors.primary, size: 20),
                            ),
